...
from algorithm_rl.algo02_dqn import DQN
...
class RLAgent(u.TorchSerializable):
    ...
    def train_model(self, i_episode, step, done):
        ...
        self.algorithm_rl.train_model(sars_batch, s, a, ext_r, next_s, done)
...
if __name__ == "__main__":
    ...
    algorithm_rl = DQN(state_size, action_size, action_range)
